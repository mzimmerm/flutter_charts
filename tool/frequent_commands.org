...
# Run unit tests + all screen-comparing integration tests (allSupported = chartsGalleryNew + origAllTestedOld)
tool/test/run_all_tests.sh allSupported
# Run unit tests + auto-layout screen-comparing integration tests
tool/test/run_all_tests.sh chartsGalleryNew
# Run unit tests + manual-layout screen-comparing integration tests
tool/test/run_all_tests.sh origAllTestedOld
...
#+begin_src: sh
  ...
  flutter drive \
    --dart-define=EXAMPLE_DESCRIPTORS="allSupported" \
