...
#              'tmp-script-program flutter drive --target integration_test/deprecated_v1/screenshot_create_deprecated_v1_test.dart'
...
#          'flutter test  test/deprecated_v1/screenshot_validate_deprecated_v1_test.dart'
#           which compares
...
source tool/test/deprecated_v1/start_emulator_and_generate_example_descriptor.sh \
  "$isFirstRun" \
  "$exampleEnum" \
  "$chartTypeEnum" \
  "$chartOrientation" \
...
echo         on file \"deprecated_v1/screenshot_create_deprecated_v1_test.dart\".
