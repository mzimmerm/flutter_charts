...
# ONLY a wrapper for tool/test/deprecated_v1/integration_test_create_then_validate_screenshots.sh
...
tool/test/deprecated_v1/integration_test_create_then_validate_screenshots.sh "firstRun" "$exampleEnum"

# Example of new/old, running only screenshot-create test:
#   CHART_LAYOUTER=oldManualLayouter tool/test/deprecated_v1/run_one_create_then_validate_screenshot_test.sh ex75AnimalsBySeasonLegendIsRowStartTightItemIsRowStartTightItemChildrenPadded