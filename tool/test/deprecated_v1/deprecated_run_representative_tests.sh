...
tool/test/deprecated_v1/integration_test_create_then_validate_screenshots.sh nextRun ex35AnimalsBySeasonNoAxisNoGridLinesNoLabelsShown
...
tool/test/deprecated_v1/integration_test_create_then_validate_screenshots.sh nextRun ex52LogarithmicScale
