...
** IN-PROGRESS-NOW ~3. SOME Containers : Use the new Layouter algorithm + new Box/Column layouts instead of custom code~

*** NOTE ~SOME Containers = LegendContainer, LegendItemContainer, LabelContainer~

*** 
** NOTE Containers structure analyzed
...
** IN-PROGRESS 8. New Layouter algorithm
...
** TODO 9. New Box/Column layouts
** TODO 4. REST Containers : Use the new Layouter algorithm + new Box/Column layouts instead of custom code
...
** DONE DONE in new Containers refactoring and new Layout refactoring
...
*** DONE NO - Split Container to Layouter and Painter
