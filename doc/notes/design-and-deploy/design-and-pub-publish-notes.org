...
** IN-PROGRESS-NOW 5.2 Resolve todo-00-last

- [ ] start resolving todo-00-last
  - [ ] D mostly around the sandboxes first. What do we need in sandbox?  

  - [ ] D Add the parent parameter and ensure things in parent sandbox invoked from parent context.
  - [ ] D Make sure all methods of newCoreLayout are implemented
  - [ ] D Resolve all other todo-00-last
  - [ ] 
- [ ] MILESTONE !!!!!! vvvvvvv 
