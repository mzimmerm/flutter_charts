...
** DONE 3. ~Constraints and LayoutExpansion: Refactor LayoutExpansion to BoxContainerConstraints and clarify role of BoxContainerConstraints~
...
** IN-PROGRESS-NOW 4. Split Container to Layouter and Painter
...
- [ ] Add hierarchy stuff
  - [ ] ~BoxContainerParentSandbox parentSandbox~
    - [ ] layoutSize
    - [ ] constraint
    - [ ] ?
...
*** IN-PROGRESS-NOW Implement core of Layouter algorithm 
...
*** TODO Apply Layouter algorithm ONLY in Legends panel as a proof of concept
