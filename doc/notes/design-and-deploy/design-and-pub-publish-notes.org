...
21. [ ] Rename ChartViewMaker to ChartViewModel, implement ChartModel and add forwarding methods to ChartModel:
    1. [ ] Remove ChartModel from signatures, and use ChartViewModel instead
    2. [ ] Pull LabelLayoutStrategy to ChartViewModel
22. [ ] Add tests for PointOffset lextr method
23. [ ] Replace PointOffset lextr method and use with proper 2d transforms thought through in Terra Cotta
24. [ ] Exclude from backups:
...
** More current work
     ...
     PointOffset fromPointOffset = PointOffset(
 inputValue: 8.333333333333334,
 outputValue: 2000.0,
 );
     PointOffset pixelPointOffset = pointOffset.lextrToPixelsMaybeTransposeInContextOf(
  chartOrientation: column,
  constraintsOnImmediateOwner: BoxContainerConstraints.insideBox(Size(8.392857142857144, 435.42857142857144),
  inputDataRange: Interval(0.0, 100.0),
  outputDataRange: Interval(-1000.0, 2300.0),
 ...
 inputValue: 0.699404761904762,
 outputValue: 39.58441558441558,
 );
     ui.Size pixelPointOffsetLayoutSize = Size(8.392857142857144, 263.8961038961039);
     assertOffsetResultsSame(pixelPointOffset, PointOffset(
 inputValue: 0.699404761904762,
 outputValue: 39.58441558441558,
 );
     assertOffsetResultsSame(pixelPointOffset.barPointRectSize, Size(8.392857142857144, 263.8961038961039);
     PointOffset fromPointOffset = PointOffset(
 inputValue: 8.333333333333334,
 outputValue: 1100.0,
 );
  ...
  constraintsOnImmediateOwner: BoxContainerConstraints.insideBox(size: const Size(8.392857142857144, 435.42857142857144)),
  ...
  isLextrUseSizerInsteadOfConstraint: false,
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(
 inputValue: 7.693452380952382,
 outputValue: 336.46753246753246,
 );
     assertOffsetResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 32.98701298701299);
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 0.699404761904762,outputValue: 39.58441558441558,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 0.699404761904762,outputValue: 158.33766233766232,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 0.699404761904762,outputValue: 303.4805194805195,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 2.098214285714286,outputValue: 65.97402597402595,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 2.098214285714286,outputValue: 171.53246753246754,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 2.098214285714286,outputValue: 290.28571428571433,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 3.49702380952381,outputValue: 13.194805194805213,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 3.49702380952381,outputValue: 145.14285714285717,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 4.895833333333334,outputValue: 197.92207792207793,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 4.895833333333334,outputValue: 283.6883116883117,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 6.294642857142858,outputValue: 79.16883116883116,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 6.294642857142858,outputValue: 211.11688311688312,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 7.693452380952382,outputValue: 65.97402597402595,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 237.5064935064935));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 7.693452380952382,outputValue: 197.92207792207793,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 105.55844155844156));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 0.699404761904762,outputValue: 409.0389610389611,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 105.55844155844156));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 2.098214285714286,outputValue: 356.2597402597403,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 3.49702380952381,outputValue: 329.87012987012986,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 3.49702380952381,outputValue: 343.06493506493507,));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 4.895833333333334,outputValue: 356.2597402597403,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 52.77922077922078));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 6.294642857142858,outputValue: 316.6753246753247,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 13.194805194805195));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 6.294642857142858,outputValue: 329.87012987012986,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 26.38961038961039));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 7.693452380952382,outputValue: 323.27272727272725,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 19.792207792207794));
     ...
     assertOffsetResultsSame(pixelPointOffset, PointOffset(inputValue: 7.693452380952382,outputValue: 336.46753246753246,));
     assertSizeResultsSame(pixelPointOffset.barPointRectSize, const Size(8.392857142857144, 32.98701298701299));


*** DONE Introduce control over divided Constraints

1. [X] In Constraints, add variable isDividedWidthFromParent, isDividedHeightFromParent, default false, also method isDividedLengthFromParentAlong(LayoutAxis).
2. [X] In TransposingRoller.Column, Row layout method (which?), if  !isDividedLengthFromParentAlong(mainLayoutAxis) and Align=Align.end, or center, is used, add a WARNING.
3. [X] In TransposingRoller.Column, Row, add parameter isMainAxisFlipAlign, isCrossAxisFlipAlign, default false. If set to false, the otherEndAlign is NOT performed when creating Row, Column in factory.
    
** Add Spacing to chart
...
ex72AnimalsBySeasonLegendIsRowCenterLooseItemIsRowEndLoose_barChart.png
