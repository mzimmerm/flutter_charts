...
** DONE 11.2. ~Line chart~ 2 days. Started May 20 (started day late) finished May 23
...
** DONE ~Remove all usages of Model classes in data_container.dart files. Only talk to ChartViewModel.~ 1/2 day - started May 24
...
** IN-PROGRESS-NOW ~Create a test app for super fast testing~ 2 days, but be willing to give up. Should start May 23, started May 24
...
- [ ] Start with only screenshot, as that is necessary condition to be able to do even do this.
- [ ] 
- [ ] Is the test app: copy or extension of main.dart? PROBABLY START WITH A COPY 
- 
