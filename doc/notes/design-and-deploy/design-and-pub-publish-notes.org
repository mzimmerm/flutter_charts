...
16. [ ] Exclude from backups:
    ...
    3. 
17. [ ] Code changes start using Transposing instead of Regular ALMOST EVERYWHERE - FIRST ASK : WHERE NOT?
    1. [ ] WHERE YES?
       - [ ] 
       - [ ] 
       - [ ] 
...
20. [ ] !!! ~TransposableRoller.Row constructor hardcodes mainAxisAlign. Should it use otherEndAlign, if set in TransposableRoller.Row???~
21. [ ] In view_maker, data_container, axis_container:
    ...
    - [ ] Introduce TransposingEdgePadding, and use it instead. Any others?
    - [ ] Status:
      - [ ]  view_maker
      - [ ]  data_container
      - [ ]  axis_container:
