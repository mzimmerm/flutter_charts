...
- [X] todo-00 Rename as test_ to as testing_     
- [X] Address // todo-00-last 
...
4. [X] USE 2 TEST APPS : ONE FOR auto_layout, OTHER for coded_layout with the eventual goal of coded_layout gone.
   ...
   4) [X] TEST FOR SAMENESS AND COMMIT
      ...
      + [X] run_all_tests.sh --auto-layout="allSupportedNew convertedToNew" --coded-layout="oldFailingInNew"
      + [X] COMMIT
...
- [X] test_main.dart: Add a non-test example ex001AnimalsBySeasonLiveLegendContainer: 
  ...
  - [X] Add example to allSupportedNew (only one, say nonStacked Bar)
  - [X] Add images
  - [X] retest and commit
- 

** IN-PROGRESS-NOW ~19. Add ability to ignore BoxContainer during layout and/or paint. USE IT to show chart without axes, and/or labels, and/or legend~

*** IN-PROGRESS-NOW Add ability to ignore BoxContainer during layout and/or paint
...
- [X] review options related to skipping. THE options VARIABLE IS CALLED 'isShown' in general :
  ...
  - [X] VerticalAxisContainerOptions.isShown
  - [X] VerticalAxisContainerOptions.isInputGridLinesShown
  - [X] todo-00-next : add this to a comment


When done: todo-00-now

- [X] Go over all todo-00- comments and implement. Changes start with:
  ...
  - [X] Simplification and correcting around - todo-00-now-progress-testing
    #+begin_src java
...
- [X] Go over remaining todo-00- comments, implement
- [X] Test, validate, commit
...
- [ ] add auto_layout examples as in coded_layout which skips labels, axis, grid
  - [ ] Rename: ex35AnimalsBySeasonNoLabelsShown => ex35AnimalsBySeasonNoAxisNoGridLinesNoLabelsShown
  - [ ] Add: ex36AnimalsBySeasonNoOutputAxisOrOutputAxisParallelGridLinesShownButInputAxisLabelsAxisLinesShown : should show all labels (input and output), show InputAxis and InputAxisParallelGridLines, NO OutputAxis NO OutputAxisParallelGridLines
  - [ ] Add to test:
    - [ ] ex35 new layout, only column orientation, bar and line (2 images)
    - [ ] ex36 new layout, column and row orientation, bar and line (4 images)
- [ ] Save new images as appropriate
- [ ] Test, validate, commit


** LATER 19.1. Design of LayoutableBox, BoxLayouter, BoxContainer, BoxContainerHierarchy and possible changes
...
#+begin_src artist
    ...
    |                                                                                      |              |                                                                                        |
    |                                                                                      |              |                                                                                        |
    |   todo-00 abstract:                                                                  |              |   todo-00 abstract:                                                                    |
    |   todo-00 concrete:                                                                  |              |   todo-00 concrete:                                                                    |
    |                                                                                      |              |                                                                                        |
    |                                                                                      |              |                                                                                        |
    |                                                                                      |              |   todo-00 finish this                                                                  |
    |                                                                                      |              |                                                                                        |
    |   todo-00 pen is for inputting text. text is for figlets                             |              |                                                                                        |
    |                                                                                      |              |                                                                                        |
    |                                                                                      |              |                                                                                        |
    |                                                                                      |              |                                                                                        |
    +--------------------------------------------------------------------------------------+              +----------------------------------------------------------------------------------------+
...
** TODO-NEXT ~20. Fix charts that are NOT working in new auto_layouter~
...
*** TODO-NEXT Failing known reason - a chart without labels not implemented
...
*** TODO-NEXT Failing to rotate or skip labels
...
** TODO-NEXT ~21. Refactor / rename consideration~

 - [ ] *CONSIDER* in view_model.PointModel rename outputValue to trfdOutputDatum *but this is used a lot and related to a lot of other naming that would have to change as well*
 - [ ] Consider rename around FromTransposing2DValueRange to FromTransposing2DDataInterval *but agains this is used a lot and related to a lot*
 - [ ] Rename boundingRect to envelopeRect
 - [ ] 
 - 

** TODO-NEXT ~22. Figure out how to create, name, and keep some basic chart layout templates, similar to LegendAndItemLayoutEnum - e.g. to pre-layout Y axis~ 4 days. Should start June 2, end June 5.
...
** LATER-BUT-REVIEW-NEXT Follow linter rules: 1) in late final and 2) use package imports (no relative imports)
...
** TODO ~25. HUGE: Containers to MORPHS~
