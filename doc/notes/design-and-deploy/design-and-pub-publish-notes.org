...
**** TODO Rename distributedLabels to distributedLabelYs
**** TODO Rename yLabelsDividedInYAxisRange  to manuallyDistributedLabelYs
...
**** TODO Manual vs Automated layout changes
...
- [ ] Manual layout does not use Range. Make it use Range and work semantically same as manual layout:
  ...
  #+end_src
- [ ] Remove Range and pull it's functionality to YScalerAndLabelFormatter
  - [ ] Range only manages a list of values, that represents labels anyway! Do this:
    - [ ] Move the 2 members from Range to YScalerAndLabelFormatter
    - [ ] Move Range.makeYScalerWithLabelInfosFromDataYsOnScale to YScalerAndLabelFormatter private method, called from it's constructor
    - [ ] Remove Range
    - [ ] Fix tests and test
...
**** TODO Move construction of XContainer, YContainer and others from the ChartTopContainer.layout() method to ChartTopContainer constructors. This may be questionable!! *THINK**
