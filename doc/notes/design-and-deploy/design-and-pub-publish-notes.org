...
*** IN-PROGRESS-NOW Allow extendable Legend Layout
...
- [ ] todo-00 Rename as test_ to as testing_     
- [ ] Address // todo-00-last 
- [ ] Equivalent of the above for ~LegendItemContainer~
   

*** IN-PROGRESS-NOW Clarify difference _make , _create
