...
** DONE 5. Container structural changes: Make Containers (Layouters?) a hierarchy and add fields, towards "Everything is a container"
*** DONE Add members and methods to Container class: parent, children, traverse(), flatten(), parentSandbox (maybe this in Layouter)
...
** IN-PROGRESS-NOW ~6. HIERARCHY OF CONTAINERS - notes and progress towards "everything is a container"~
...
*** IN-PROGRESS-NOW Ensure code sets up the parent/child hierarchy correctly in SOME existing containers
...
** TODO 7. Container: Refactorings SOME containers to use Container new structure from item 6
...
** IN-PROGRESS 8. Layouter algorithm: define and implement
