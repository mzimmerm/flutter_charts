...
** IN-PROGRESS-NOW ~18. Simplify project structure regarding coded_layout: Make coded_layout and new_layout less dependend for testing: Remove SwitchViewModels, switch_view_model.dart, LiveOrTesting use instead test_coded_layou_main.dart in addition to test_main.dart~
...
*** IN-PROGRESS-NOW Remove SwitchViewModels, switch_view_model.dart, LiveOrTesting
...
test/switch/coded_layout/line   LineChartViewModelCL         extends auto_layout_line_chart_view_model.LineChartViewModelCL
   ...
   - [-] move everything from switch directory away:
     ...
     - [ ] same for bar
     - [ ] special care: view_model_cl.dart - where to move?
   - [ ] Rename packages 'as switch' such as switch_auto_layout_bar_view_model
   - [ ] Search for switch Switch
...
- [ ] Ensure
  ...
  - is used everywhere with 'as view_model'

*** Notes from deleted code

**** Example of extending dynamic enum

Deleted a file options.dart with contents:

#+name: test-slash-option
#+begin_src java
