...
19. [ ] More steps here, or should all work for both column and row???
20. [ ] Add tests for PointOffset lextr method
21. [ ] Replace PointOffset lextr method and use with proper 2d transforms thought through in Terra Cotta
22. [ ] 
