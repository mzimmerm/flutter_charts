...
*** IN-PROGRESS-NOW Look at ~PointsColumns~ as the interesting place where ChartData.dataRows are transferred to the chart. Start at ~_drawDataPresentersColumns~
...
*** IN-PROGRESS-NOW Move all re-layout specific settings from options to DefaultIterativeLabelLayoutStrategy

*** TODO Refactor and document Poly

*** TODO *DOCUMENT ON PAPER ALL CLASSES USED IN CHARTS*
*** TODO Summarize changes in README.md
