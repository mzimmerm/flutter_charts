...
*** DONE Merge to master, and create a new branch flutter_charts_v4

branch flutter_charts_v4_2023-01-26_convert_Presenters_to_BoxContainers



*** IN-PROGRESS-NOW See if GridLinesContainer _lineContainers can delegate to GridLinesContainer.children


*** IN-PROGRESS-NOW Where possible, Make sure paint and apply methods use the default implementation that iterates on children NOT on members
...
- [X] LineContainer
- [ ] GridLinesContainer
- [ ] DataContainer and extensions:
  - [ ] LineChartDataContainer
  - [ ] VerticalBarChartDataContainer
  
  
*** IN-PROGRESS-NOW Deep refactoring to make "everything is a BoxContainer parent/child hierarchy correctly": for ~Presenter - VerticalBarPresenter, LineAndHotspotPresenter to Container conversion~


**** IN-PROGRESS-NOW Initial investigations and steps



**** TODO-NEXT Conversion of ~Presenters~ to ~BoxContainer~
