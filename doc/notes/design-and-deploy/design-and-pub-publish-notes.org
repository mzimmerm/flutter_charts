...
- [-] Debug layouting:
  - [X] Place some packing or lineup so that legend is off the chart
  - [ ] Debug behavior, make sure it throws exception wher beyound painted rectangle somewhere - *this is hard to do right but possible, leaving for later*
