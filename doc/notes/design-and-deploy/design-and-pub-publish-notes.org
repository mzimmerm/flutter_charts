...
17. [ ] Introduce TransposingEdgePadding, and use it in all 3. Any others?
18. [ ] Change  Row -> Transposing.Row and  ExternalTicksRow -> TransposingExternalTicks.Row in code, but NOT TransposingSizer
19. [ ] Remove       ~chartSeriesOrientation: chartSeriesOrientation~ in all places where ~chartViewMaker~ is provided. This is generally in extensions of ChartAreaContainer, but NOT in layouter or transposing layouters.
20. [ ] Rename otherEndAlign to flipAlign, and add the method on extended Align object
