...
** IN-PROGRESS-NOW Refactor naming around view_model.ChartViewModel and label_model.AxisIntervalTicksAndLabelsDescriptor
...
- [ ] Maybe:
  - [ ] *CONSIDER* in view_model.PointModel rename outputValue to trfdOutputDatum *but this is hard, used a lot*
  - [ ] look at places where 'transformed' is used and rename to trfd??
  - [ ] look at places where 'envelope' is used and rename
...
*** TODO-NOW 3 3. Failing due to ordinal user labels
...
*** TODO-NOW 2 6. Failing due to no data but it should be fixed
...
The relevant error-causing widget was: 
  BarChart BarChart:file:///home/mzimmermann/dev/my-projects-source/public-on-github/flutter_charts/lib/test/src/test_main.dart:1123:29
When the exception was thrown, this was the stack: 
#2      new AffineRangedMap1D (package:flutter_charts/src/util/util_dart.dart:484:17)
#3      new ToPixelsAffineMap1D (package:flutter_charts/src/util/util_dart.dart:604:8)
#4      ExternalTicksLayoutDescriptor._affmapValuesToPixels.<anonymous closure> (package:flutter_charts/src/morphic/container/container_layouter_base.dart:4114:42)
#5      MappedListIterable.elementAt (dart:_internal/iterable.dart:442:31)
#6      ListIterator.moveNext (dart:_internal/iterable.dart:371:26)
#7      new _GrowableList._ofEfficientLengthIterable (dart:core-patch/growable_array.dart:194:27)
#8      new _GrowableList.of (dart:core-patch/growable_array.dart:154:28)
#9      new List.of (dart:core-patch/array_patch.dart:39:18)


** IN-PROGRESS-NOW Add ability to ignore BoxContainer during layout and/or paint. Used to show chart without axes, and/or labels, and/or legend
