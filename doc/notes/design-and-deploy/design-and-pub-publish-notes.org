...
- [ ] Add container Greedy, equivalent of Expanded with ratio
  - [ ] Greedy:
    ...
    - [ ] has member int greed - direction is implied by parent : if parent is Row, horizontal, Column vertical
    - [ ] it's parent (which should be Row or Column) should do in override of ~_post_IfNotLeaf_Offsetting_LayoutMyChildren_Then_OffsetChildrenInMe_AccordingToLayouter~???:
