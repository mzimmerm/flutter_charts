...
IMPORTANT: ~BoxContainer~ implements ~BoxLayouter~, ONLY ADDS METHOD ~paint(Canvas)~
...
*** NOTE ~New Layout on SOME Containers = LegendContainer, LegendItemContainer, LabelContainer~
