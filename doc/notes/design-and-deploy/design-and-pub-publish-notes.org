...
** *README.md*: add changes, and *make sure image links point to this link: ~file:/doc/readme_images~, for example:* [ [file:doc/readme_images/README.org_IMGID.png] ]
...
- [ ] Change the links in the README.MD file by search-and-replace the string 
...
** TODO *README.md*: on https://github.com/mzimmerm/flutter_charts - check if image links in README.md have a full path to http
