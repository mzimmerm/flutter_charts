...
*** Remove buildContainerOrSelf from interface.

1. classes that use is, move contents to constructor
2. remove from interface
3. deal with default BoxContainer constructor
