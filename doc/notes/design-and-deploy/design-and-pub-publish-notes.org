...
*** TODO-NOW 18.3 Add a example ex200 with non-test LegendContainer
...
- [X] test and commit
- [ ] Add 2 *live* LegendContainer layout factories
  - [ ] Center - find current test defauls legendIsRowStartTightItemIsRowStartTightDefault
  - [ ] Change name legendIsRowStartTightItemIsRowStartTightDefault to legendIsRowStartTightItemIsRowStartTight
  - [ ] Add 
  - [ ] WrappingRow (exists: liveLegendIsRowStartTightItemIsRowStartTightDefault) - legend_container.LegendContainer.liveLegendIsRowStartTightItemIsRowStartTightDefault - DEFAULT
- [ ] test_main.dart: Add a non-test example ex001AnimalsBySeasonLiveLegendContainer: 
  - [ ] add enum to all switches:
    - [ ] add to all switches: In TEST LegendContainer, throw exception, it should not reach ex200
  - [ ] Use animal data
  - [ ] Use live LegendContainer default
  - [ ] Comment as example of using live LegendContainer which does NOT use enums internally (as opposed to test LegendContainer) 
  - [ ] Add example to allSupportedNew (only one, say nonStacked Bar)
  - [ ] Add images
  - [ ] retest and commit
- 

** TODO-NOW ~19. Add ability to ignore BoxContainer during layout and/or paint. USE IT to show chart without axes, and/or labels, and/or legend~

This todo is also documented in container_layouter_base.dart


- [X] Go over code that runs either coded_layout or auto_layout and document how examples are found and run - also which layout they use etc.
