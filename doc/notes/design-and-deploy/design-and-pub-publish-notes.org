...
- [ ] All classes in  coded_layout make CL. Concentrate on all 'presenter.dart' files
- [ ] Ensure no CL class used outside coded_layout, maybe with minor well defined exceptions
