...
** DONE Separate integration test images between 'oldManualLayouter' and 'newAutoLayouter'. Identify charts that do NOT work in auto_layout.
...
** DONE Refactor naming around view_model.ChartViewModel and label_model.AxisIntervalTicksAndLabelsDescriptor
...
** IN-PROGRESS-NOW Fix charts that are NOT working in new auto_layouter
...
*** TODO-NOW ex72: INTENTIONALLY OVERFLOWING because Legend layout INTENTIONAL overflow makes chart ALSO overflow
...
Interval fix did NOT help this bug
...
** TODO-NOW Refactor / rename consideration
...
** TODO-NOW Add ability to ignore BoxContainer during layout and/or paint. Used to show chart without axes, and/or labels, and/or legend
...
** IN-PROGRESS ~18. Figure out how to create, name, and keep some basic chart layout templates, similar to LegendAndItemLayoutEnum - e.g. to pre-layout Y axis~ 4 days. Should start June 2, end June 5.
