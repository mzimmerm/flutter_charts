...
The reason is, the published package website only allows links to the ~doc/~ directory. So all images must be in ~doc/~.
...
** TODO *todo-00-soon* Replace scaler with a more elegant, see gpilt I did there. See todo-00-last-last
