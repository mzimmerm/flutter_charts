...
** IN-PROGRESS-NOW 11. ~CURRENT WORK: ADD LINE CHART~
...
- [ ] Make all fields named 'owner' to be final; also rename them to 'outer'


- [-] Rename LegendColumn to ByRowLegends
  - [X] Rename LegendColumn to ByRowLegends
  - [ ] Write up here what else to rename
- [ ] Refactor DataContainer in BarChart:
  - [ ] Bar chart: DataContainer : create extension BarChartDataContainer in container/bar/data_container.dart:
    - [ ] Use the existing mechanism, override the 3 methods that throw UnimplementedError, this does not need to override all data_container classes, and keep the core layout intact
      - [ ] makeDataColumnPointsBar
      - [ ] makePointContainer
      - [ ] makePointContainerWithZeroValue
    - [ ] df 
    - [ ] watch bar chart specific methods there - mostly around BarPointContainer and DataColumnPointsBar.makePointContainer
      - [ ] DataColumnPointsBar.makePointContainer what to do, how?
    - [ ] Get Bar Chart working again in the new structure
  - [ ] Line Chart: 
