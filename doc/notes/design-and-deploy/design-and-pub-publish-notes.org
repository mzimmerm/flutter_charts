...
- ChartContainer
  ...
  - DataContainer
  - 
*** IN-PROGRESS Make Containers a hierarchy

**** ~Add layouts and constraints~
- Add layout.dart -
...
**** ~LayoutExpansion~ - merge it somehow with ~Constraint~!!!
**** ~Remove _paintYLabels and similar~, just replace with content of the method. 
...
- [ ] ~CONVERT THE IN-BETWEENS TO CONTAINERS~
  - [ ] PointsColumn
  - [ ] PointsColumns
