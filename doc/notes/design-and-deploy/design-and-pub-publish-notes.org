...
*** TODO todo-11-last : Move all re-layout specific settings from options to DefaultIterativeLabelLayoutStrategy
*** TODO Go over remaining // todo-11-later
*** TODO Refactor and document Poly
*** TODO Refactor and document StackableValuePoint - maybe not, *move this to Morph tasks, and as that StackableValuePoint is a Container (Morph)*
...
** IN-PROGRESS 4. Deeper refactorings to make flutter_charts a bit like Morphic (marginally like it)
