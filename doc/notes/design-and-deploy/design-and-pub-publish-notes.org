...
| ex35AnimalsBySeasonNoLabelsShown_barChart_column_stacked_newAutoLayouter.png                                                  | okular integration_test/screenshots_expected/ex35AnimalsBySeasonNoLabelsShown_barChart_column_stacked_oldManualLayouter.png & okular integration_test/screenshots_tested/ex35AnimalsBySeasonNoLabelsShown_barChart_column_stacked_newAutoLayouter.png                                                                                                   | ex35AnimalsBySeasonNoLabelsShown_barChart_column_stacked_oldManualLayouter.png                                                | NO                        | [err  3] in new, shows labels, grid, and axes, but it should not. NOte: in old as expected, the non dislayed is NOT layed outin new as expected: legend does not show |
| ex35AnimalsBySeasonNoLabelsShown_lineChart_column_nonStacked_newAutoLayouter.png                                              | okular integration_test/screenshots_expected/ex35AnimalsBySeasonNoLabelsShown_lineChart_column_nonStacked_oldManualLayouter.png & okular integration_test/screenshots_tested/ex35AnimalsBySeasonNoLabelsShown_lineChart_column_nonStacked_newAutoLayouter.png                                                                                           | ex35AnimalsBySeasonNoLabelsShown_lineChart_column_nonStacked_oldManualLayouter.png                                            | NO                        | [err  3]                                                                                                                                                              |
...
- [ ] add auto_layout examples as in coded_layout which skips labels, axis, grid
  - [ ] Rename: ex35AnimalsBySeasonNoLabelsShown => ex35AnimalsBySeasonNoAxisOrGridLinesNoLabelsShown
  - [ ] Add: ex36AnimalsBySeasonNoOutputAxisOrOutputAxisParallelGridLinesShown : should show all labels (input and output), show InputAxis and InputAxisParallelGridLines, NO OutputAxis NO OutputAxisParallelGridLines
  - [ ] Add to test:
