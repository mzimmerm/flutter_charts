...
*** DONE 1. Failing unexplained, but something to do with all-negative or all-positive values that do not start at 0
...
*** TODO-NEXT 2. Failing known reason - a chart without labels not implemented
...
*** IN-PROGRESS-NOW 3. ex40 Failing due to ordinal user labels

failing in bar chart mode - seems like overflow on the chart

rename axisIntervalWhenStringLabels => axisIntervalWhenUserLabels
...
*** TODO-NEXT 4. Failing to rotate or skip labels
...
*** TODO-NOW 1 5. Failing reason unkown
...
*** DONE 6. ex900 Failing due to all data 0.0 
...
** TODO-NOW Refactor consideration
