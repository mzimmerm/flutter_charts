...
- [ ] After hot reload, switching between Line and Vertical charts, the labels start being skipped: DefaultIterativeLabelLayoutStrategy._showEveryNthLabel actually increases.
- 
...
*** IN-PROGRESS Move all painting from ChartPainter.paint to ChartContainer.paint!!
