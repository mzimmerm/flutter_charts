...
- [ ] constraints
- [ ] layoutSize - this does NOT have apply - just late final



*** Can we make layoutSize result of layout and not store on newCoreLayout?

- [ ] layoutSize member: Make still available as late final on BoxLayouter, set it after return in case it is needed later. Always set just after return from newCoreLayout.
- [P] constraints member: Remove  
