...
- [-] Add ability in Main and in LegendContainer to create example which overrides creation of ~LegendContainer~
  - [-] We need the ability to define different LegendContainer and LegendItemContainer example variations, and a way to push from this code which example we want, and in the code, implement the example variations.
