...
- [ ] ex30AnimalsBySeasonWithLabelLayoutStrategy seems to repeat animal data - FIX and validate
- [ ] test_main.dart - pull animal data up as default and change examples using them
- [ ] find other examples that use animal data
- [ ] test and commit
- [ ] Add 2 *live* LegendContainer layout factories
  - [ ] Center - find current test defauls
...
- [ ] test_main.dart: Add a non-test example ex200AnimalDataWithLiveLegendContainer: 
  - [ ] add enum with good name to all places:
