...
- [ ] Containers should have either single child or multiple children
  ...
  - [ ] Or just change allowed signature on single-child constructors.
  - [ ] Add maxChildren overrides ad appropriate to each container
- [ ] Make sure Tests work
- [ ] Add PaddingLayouter that can be used around single child to pad with space - no painting needed?
  - [ ] Use PaddingLayouter in Legend and LegendItemContainer to make sure they can be 
  - [ ] Test work
