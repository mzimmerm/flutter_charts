...
- [-] LayouterOutput classes - 
  ...
  - [X] Make calls to paint - this is in painter
    ...
    - [X] YLayouter
    - [X] LegendLayouter
  - [-] Rename LayouterOutput classes LayouterPainter and move the ability to paint there 
    - [X] XLayouter
    ...
    - [-] LegendLayouter
      ...
      - [X] legendLayouterOutput -> legendLayoutPainter
      - [ ] legendOutputs -> legendLayoutPainters
  - [ ] Make LayouterPainter members private.
