...
- [-] LayouterOutput classes - 
  - [-] add methods applyOffsetInParent(Offset offset). 
    - [X] XLayouter
    - [ ] YLayouter
    - [ ] LegendLayouter
  - [-] add method paint(Canvas canvas)
    - [X] XLayouter
    - [ ] YLayouter
    - [ ] LegendLayouter
  - [-] add Offset _offsetInParent
    - [X] XLayouter
    - [ ] YLayouter
    - [ ] LegendLayouter
  - [-] Make calls to applyOffsetInParent - This is at places where xOutputs, yOutputs, layouterOutputs are created!
    - [X] XLayouter
    - [ ] YLayouter
    - [ ] LegendLayouter
  - [-] Make calls to paint - this is in painter
    - [X] XLayouter
    - [ ] YLayouter
    - [ ] LegendLayouter
