...
- [X] Note only: Labels printed and layed out using *LabelPainter* in label_painter. this is used in
  ...
  - [X] YLayouter
  - [X] LegendLayouter
- [X] LayouterOutput classes - 
  - [X] add methods applyOffsetInParent(Offset offset). 
    - [X] XLayouter
    - [X] YLayouter
    - [X] LegendLayouter
  - [X] add method paint(Canvas canvas)
    - [X] XLayouter
    - [X] YLayouter
    - [X] LegendLayouter
  - [X] Make calls to applyOffsetInParent - This is at places where xOutputs, yOutputs, layouterOutputs are created!
    - [X] XLayouter
    - [X] YLayouter
    - [X] LegendLayouter
  - [X] Make calls to paint - this is in painter
    - [X] XLayouter
    - [X] YLayouter
    - [X] LegendLayouter
  - [X] Rename LayouterOutput classes LayouterPainter and move the ability to paint there 
    - [X] XLayouter
      - [X] XLayouterOutput -> XLayoutPainter
      - [X] xLayouterOutput -> xLayoutPainter
      - [X] xOutputs -> xLayoutPainters
    - [X] YLayouter
      - [X] YLayouterOutput -> YLayoutPainter
      - [X] yLayouterOutput -> yLayoutPainter
      - [X] yOutputs -> yLayoutPainters
    - [X] LegendLayouter
      - [X] LegendLayouterOutput -> LegendLayoutPainter
      - [X] legendLayouterOutput -> legendLayoutPainter
      - [X] legendOutputs -> legendLayoutPainters
  - [X] Make LayouterPainter members private.

- [X] layouters: Replace all places using Iterable.generate with a simple loop.
- [X] Test everything works
- [-] Separate creation of xLayoutPainters and xGrid
  - [X] new class *XGridLinesLayoutPainter*
  - [ ] ChartLayouter new member *xGridLinesLayoutPainter*, replaces *horizGridLines*
  - [ ] start creating XGridLinesLayoutPainter during creation of xLayoutPainters -
  - [ ] separate creation of xLayoutPainters and xGrid
    - [ ] new class *XLinePresenter* extends LinePresenter
    - [ ] XLinePresenter - move all relevant members from XLayoutPainter
  - [ ] Whenever a new XLayoutPainter is created:
   
    - [ ] create a new *YGridLinesLayoutPainter.yLinePresenter*

    - [ ] At that point, 

      - [ ] !!! must set the *YGridLinesLayoutPainter.yLinePresenter* lineFrom and lineTo to same values as in *get vertGridLines* !!!!!

      - [ ] must call applyParentOffset
...
- [ ] rename YLayoutPainter to YLabelPainter
- [ ] rename XLayoutPainter to XLabelPainter
- [ ] rename yOutput to yLabelPainter
- [ ] rename xOutput to xLabelPainter
...
- [ ] X axis: wrap painters (XLayoutPainter), to 
