...
- [[#flutter-charts---an-introduction][Flutter Charts - an introduction]]
- [[#sample-flutter-charts-application-output][Sample Flutter Charts application output]]
...
- [[#experimenting-with-flutter-charts-using-the-included-sample-app-flutter_charts_sample_appdart][Experimenting with Flutter Charts: Using the included sample app flutter_charts_sample_app.dart]]
- [[#flutter-charts---samples-linechart-and-verticalbarchart-code-and-resulting-charts][Flutter Charts - samples: LineChart and VerticalBarChart. Code and resulting charts]]
...
- [[#future-enhancements-and-work][Future enhancements and work]]
...
- [[#internal-notes][Internal notes]]
  ...
  - [[#conversion-of-readmeorg-to-readmemd---steps][Conversion of README.org to README.md - steps]]
  - [[#add-link-to-known-client-packages][Add link to known client packages]]
  - [[#flutter_charts-publish-workflow----publish-flutter_charts-on-pub][*Flutter_charts publish workflow*  - Publish flutter_charts on pub]]

* Flutter Charts - an introduction
...
There is one sample application in flutter_charts: example/chart/chart_usage_example.dart. You can run the application using one of the methods (6, 7) in the paragraph below.
...
* Flutter Charts - samples: LineChart and VerticalBarChart. Code and resulting charts
...
** TODO Conversion of README.org to README.md - steps
** TODO Add link to known client packages

** TODO *Flutter_charts publish workflow*  - Publish flutter_charts on pub
...
- [ ] Optionally, *test the flutter_charts_sample_app* - this tests the published package
