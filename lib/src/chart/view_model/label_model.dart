...
///    2. [outputValue]    -- using [DataRangeTicksAndLabelsDescriptor.affmapValueToPixels]
///       ==> [parentOffsetTick]
  ...
  })  : _labelInfoList = from
  {
    ...
    for (int i = 0; i < _labelInfoList.length; i++) {
      ...
      if (userLabels != null) {
        ...
        labelInfo._formattedLabel = rangeDescriptor._valueToLabel(labelInfo._rawOutputValue);
      }
    }
  }
