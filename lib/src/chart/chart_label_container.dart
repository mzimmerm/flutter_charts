...
/* todo-00-last-last-done
  ...
  ///   which obtains the size of [_textPainter]. The resulting [layoutSize] of this [ChartLabelContainer]
  ...
  // do NOT override from mixin : @override
  void _layoutLogicToSetMemberMaxSizeForTextLayout() {
    ...
    // todo-00-last-last-done simplified
