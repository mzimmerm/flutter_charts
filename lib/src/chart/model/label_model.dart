...
class DataRangeLabelInfosGenerator {
  ...
  ///
  /// todo-011 : improve
  ///   - If [userLabels] is set, the returned list in [labelInfoList] is in the same order as [userLabels].
  ///   - Otherwise, data labels are generated by [DataRangeLabelInfosGenerator], and returned here in [labelInfoList].
  ///     The [labelInfo.outputValue]s in [labelInfoList] are numerically always numerically increasing.
  ///
  /// The labels' pixel layout placing is determined by values of [ExternalTicksLayoutProvider.tickPixels] created
  ///   during [ExternalTicksBoxLayouter]s layout. The [ExternalTicksLayoutProvider.tickPixels] are used
  ///   to position rectangles with the labels in the returned [labelInfoList].
  ///
  /// See [ExternalTicksLayoutProvider.tickPixels] for placement logic of the returned label infos.
...
class AxisLabelInfo {
  ...
  ///
  /// In not-transferred charts (e.g. not-log-valued charts), this is equal to [_rawOutputValue].
  ///
...
class _AxisLabelInfos {
  ...
  ///
  /// For the logic of layout placing, see [DataRangeLabelInfosGenerator.labelInfoList].
