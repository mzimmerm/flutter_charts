...
///       Note 2: The package: scheme in 1. MUST BE USED IN a) example and b) in tests in 'lib/test/src'.
...
///        in
///            'flutter_charts/(lib)/src/chart/bar',
///          CAN REACH EXPORTED OR NOT-EXPORTED LIBRARY
///            'flutter_charts/(lib)/src/chart/util/example_descriptor.dart'
///          as
///       ```dart
///          import '../util/example_descriptor.dart'; // from 'flutter_charts/(lib)/src/chart/bar'
///       ```
...
export 'package:flutter_charts/src/chart/cartesian/view_model/bar/bar_view_model.dart';
export 'package:flutter_charts/src/chart/cartesian/view_model/line/line_view_model.dart';
...
export 'package:flutter_charts/src/chart/cartesian/view_model/label_model.dart';
//export 'package:flutter_charts/src/coded_layout/chart/container.dart';
//export 'package:flutter_charts/src/coded_layout/chart/cartesian/chart_type/line/root_container.dart';
//export 'package:flutter_charts/src/coded_layout/chart/cartesian/chart_type/bar/root_container.dart';
//export 'package:flutter_charts/src/coded_layout/chart/cartesian/view_model/bar/coded_layout_bar_view_model.dart';
//export 'package:flutter_charts/src/coded_layout/chart/cartesian/view_model/line/coded_layout_line_view_model.dart';
