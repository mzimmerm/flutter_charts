...
import 'package:flutter_charts/test/src/coded_layout/chart/cartesian/view_model/line/coded_layout_line_view_model.dart' as test_line_view_model;
import 'package:flutter_charts/test/src/coded_layout/chart/cartesian/view_model/bar/coded_layout_bar_view_model.dart' as test_bar_view_model;
  ...
  Widget createRequestedChart() {
    ...
    switch (chartType) {
      case ChartType.lineChart:
        ...
        if (isLive) {
          lineChartViewModel = live_line_view_model.LineChartViewModelCL(
            chartModel: chartModel,
          ...
          lineChartViewModel = test_line_view_model.LineChartViewModelCL(
            chartModel: chartModel,
            chartOrientation: chartOrientation,
            chartStacking: chartStacking,
            inputLabelLayoutStrategy: inputLabelLayoutStrategy,
      ...
      case ChartType.barChart:
        ...
        if (isLive) {
          barChartViewModel = live_bar_view_model.BarChartViewModelCL(
            chartModel: chartModel,
            chartOrientation: chartOrientation,
            chartStacking: chartStacking,
            inputLabelLayoutStrategy: inputLabelLayoutStrategy,
          ...
          barChartViewModel = test_bar_view_model.BarChartViewModelCL(
            chartModel: chartModel,
            chartOrientation: chartOrientation,
            chartStacking: chartStacking,
            inputLabelLayoutStrategy: inputLabelLayoutStrategy,
